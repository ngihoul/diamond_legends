...
import './page.css';
import UniformPreview from '@/components/UniformPreview/UniformPreview';
        ...
        {({ values, handleChange, isValid, isSubmitting }) => (
          <Form className='team-form'>
            ...
            <div className='form-control'>
              ...
              <Field type='text' name='city' placeholder="Ville de l'équipe" />
              ...
              <div className='color-pickers'>
                <div className='form-control'>
                  ...
                  <CompactPicker
                    ...
                    onChangeComplete={(color) => setColors({ ...colors, color_1: color.hex })}
                  />
                </div>
                ...
                <div className='form-control'>
                  ...
                  <CompactPicker
                    ...
                    onChangeComplete={(color) => setColors({ ...colors, color_2: color.hex })}
                  />
                </div>
                ...
                <div className='form-control'>
                  ...
                  <CompactPicker
                    ...
                    onChangeComplete={(color) => setColors({ ...colors, color_3: color.hex })}
                  />
                </div>
              </div>
              <div className='uniform-preview'>
                <UniformPreview
                  primaryColor={colors.color_1}
                  secondaryColor={colors.color_2}
                  tertiaryColor={colors.color_3}
